...
<link rel="stylesheet" type="text/css" href="styles/<%=request.getAttribute("stylesheetName") != null ? request.getAttribute("stylesheetName")
...
<body>
	<div class="outer-container">
		...
		<div class="logo-container">
			<img src="<%=request.getAttribute("logoPath") != null ? request.getAttribute("logoPath") : "images/seasissst.png"%>"
				alt="<%=request.getAttribute("logoAlt") != null ? request.getAttribute("logoAlt") : "SE Assist Logo"%>" class="logo">
		</div>
		...
		<div class="inner-container">
			...
			<!-- 確認フォーム -->
			<form action="<%=request.getAttribute("formAction")%>" method="post" class="confirmation-form">
				...
				<div class="form-group username-container">
					<label>社員ID</label>
					<div class="result-box"><%=request.getAttribute("username")%></div>
				...
				<div class="form-group button-container">
					<!-- 登録ボタン -->
					<form action="<%=request.getAttribute("formAction")%>" method="post" style="display: inline;">
						<button type="submit" class="submit-button"><%=request.getAttribute("submitButtonText")%></button>
					</form>

					<!-- 戻るボタン -->
					<form action="<%=request.getAttribute("backButtonLink")%>" method="post" style="display: inline;">
						<input type="hidden" name="name" value="<%=request.getAttribute("name")%>">
						<input type="hidden" name="locationId" value="<%=request.getAttribute("locationId")%>">
						<input type="hidden" name="username" value="<%=request.getAttribute("username")%>">
						<input type="hidden" name="password" value="<%=request.getAttribute("password")%>">
